...
Track ecommerce events and conversions in Google Analytics 4, Google Ads, Facebook Pixel & Conversions API, Snapchat, Pinterest, Tiktok via Google Tag Manager. Build dynamic audiences and track ROAS performance in Google Ads, Meta (Facebook + Instagram), Snapchat, Pinterest, Tiktok, Microsoft Ads and Twitter to run successful shopping campaigns. Integrate Facebook Conversion API to help maximise the effectiveness of your shop's ecommerce events. Automate your product feed to Google Merchant Center for running high performing Google Shopping campaigns for your WooCommerce products to boost ROAS (Revenue on Ad Spends).
...
2. Use your own Google Tag Manager account with the plugin for full control over all the tags (70 tags), triggers and variables <strong>(<a target="_blank" href="https://conversios.io/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GTM">Pro</a>)</strong>
...
4. One click <strong>Google Analytics ecommerce tracking</strong> automation. It tracks following events:
   ...
   * All important ecommerce events (along with product and order data) like:
...
8. Google Ads Remarketing, Dynamic Remarketing and Conversion Tracking
   * Google Ads Dynamic Remarketing tags for ecommerce events (along with product and order data)
       * Product clicks
       * Product detail page view
       * Add to cart
       * Checkout
       * Purchase
   * Google Ads Conversion Tracking <strong>(<a target="_blank" href="https://conversios.io/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GACT">Pro</a>)</strong>
   * Google Ads enhanced Conversion Tracking <strong>(<a target="_blank" href="https://conversios.io/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+GAECT">Pro</a>)</strong>
9. <strong>Meta pixel (Facebook + Instagram) integration</strong> for ecommerce events (along with product and order data) like:
       * Product detail page view
       * Add to carts
       * Checkout
       * Add payment info
       * Purchase
10. <strong>Facebook Conversion API integration</strong> for ecommerce events like:<strong>(<a target="_blank" href="https://conversios.io/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+FBCAPI">Pro Feature</a>)</strong>
       * Product detail page view
       * Add to carts
       * Checkout
       * Purchase
11. <strong>Microsoft Ads pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Page view
       * Product clicks
       * Product detail page view
       * Add to cart
       ...
       * Checkout
       * Purchase
12. <strong>Pinterest pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Product views
       * Checkouts
       * Purchase
13. <strong>Snapchat pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Product view
       * Add to cart
       * Checkout
       * Purchase
       * Page view
14. <strong>Tiktok pixel integration (beta)</strong> for ecommerce events (along with product and order data) like:
       * Product detail page view
       * Add to cart
       * Intiate checkout
       * add payment info
...
15. <strong>Twitter pixel integration</strong> for ecommerce events (along with product and order data) like:
       * Page views
       * Add to cart
       * Checkout
       * Add payment info
...
18. Product feed manager for Google Merchant Center
   ...
   * Schedule your product updates <strong>(Daily/Weekly) (<a target="_blank" href="https://conversios.io/?utm_source=EE+Plugin+WordPress+Listing&utm_medium=PRO+Link&m_campaign=Upsell+at+Conversios+Plugin+ProductFeed">Pro</a>)</strong>
...
3. All the 70 GTM tags, auto configured for your Google Tag Manager container for faster page load and efficient tracking.
4. Actionable dashboard which displays the key metrics that help your ecommerce business scale faster. ecommerce conversion and checkout funnel reports that help you to visualize user journeys from the Home page to order confirmation. Product, Source/Medium and Campaign Performance Report where you can see all the respective performances.
5. Universal Analytics dashboard 1 Once you connect Google Analytics (Universal Analytics) property from the plugin, your WooCommerce store's data will look like this in your Google Analytics dashboard. The plugin captures all the data points related to ecommerce events.
6. Universal Analytics-->Conversion-->ecommerce-->Overview Your Google Analytics account will start reflecting data as shown in the screenshot.
7. Universal Analytics-->Conversion-->ecommerce-->Shopping Behavior Your Google Analytics account will start reflecting data as shown in the screenshot.
8. Universal Analytics-->Conversion-->ecommerce-->Sales Performance Your Google Analytics account will start reflecting data as shown in the screenshot. This report shows you data related to purchase events that are triggered on your WooCommerce shop.
9. Universal Analytics-->Conversion-->ecommerce-->Product Performance Your Google Analytics account will start reflecting data as shown in the screenshot. This report shows you data related to products that are triggered on your WooCommerce shop.
10. Universal Analytics-->Conversion-->ecommerce-->Checkout Behavior Your Google Analytics account will start reflecting data as shown in the screenshot. This report shows you how users are navigating to your checkout.
...
16. Product sync dashboard when no products are synced to your Google Merchant Center account. 
17. Map your WooCommerce product categories with Google Merchant Center categories
18. Map your WooCommerce product attributes with Google Merchant Center product attributes to sync/add/update products in your Merchant Center account from WordPress backend.
19. Product sync dashboard when the products are synced in your merchant center account.
20. This is the Performance Max Campaign page where you can create new campaign and also view your existing active/paused Pmax campaigns.
...
= What is Facebook Conversions API and how will it benefit my WooCommerce store?  =

1. Reduce your cost per action as a result of improved connectivity.
2. Optimise ads for actions that happen later in the customer's journey.
3. Improve measurement.
4. Reduce your cost per action as a result of increased event matching.
5. Increase data control. <a href="https://www.facebook.com/business/help/2041148702652965?id=818859032317965" target="_blank">Learn more about Facebook Conversions API</a>
