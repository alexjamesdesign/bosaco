...
class Kadence_Woomail_Designer {
	...
	public function on_plugins_loaded() {
		...
		define( 'KT_WOOMAIL_VERSION', '1.5.9' );
		...
		require_once KT_WOOMAIL_PATH . 'includes/class-kadence-woomail-customizer.php'; // Gets custom customizer set up.
		...
		require_once KT_WOOMAIL_PATH . 'includes/class-customizer-toggle-control.php'; // Adds customizer control.
		require_once KT_WOOMAIL_PATH . 'includes/class-kadence-woomail-preview.php'; // Builds the email preview for customizer.
	...
	public function on_init() {
		...
		if ( function_exists( 'WC' ) ) {
			...
			// $remove_schema = Kadence_Woomail_Customizer::opt( 'email_schema' );
